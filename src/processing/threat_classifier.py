...
class ThreatClassifier:
    ...
    def __init__(self, language: str = 'fr'):
        ...
        # Debug print only if enabled via environment variable
        self.debug = os.getenv("DEBUG_THREATCLASSIFIER", "false").lower() == "true"
        if self.debug:
            print(f"🔍 Threat classifier initialized for {language} (debug mode)")
